    ...
    <dialog id="guide-modal" className="modal">
      <div className="modal-box">
        ...
        <form method="dialog">
          ...
          <div className="pt-6">
            <h1 id="quick-guide" className="font-bold">Quick guide</h1>
            <ul className="list-disc list-inside">
              ...
              <li>Download by using the browser default download button (chrome recommended)</li>
            </ul>
            <h1 id="features" className="font-bold mt-4">Features</h1>
            <ul className="list-disc list-inside">
            ...
            <h2 id="features" className="font-bold mt-4">About image upload</h2>
              <p>Guest: The images will be automatically deleted after 3 days. Max. number of images is 20</p>
              <p>With sign-in: The image will be automatically deleted after half a year. Max. number of images is 20 per document</p>
              <p>(All images can be deleted by clicking 🗑️ button)</p>
            </ul>
            <h1 id="what-can-you-do-with-sign-in" className="font-bold mt-4">What can you do with Sign in</h1>
            <ul>
            ...
            <button
              ...
              onClick={(): void => {
                window.open('https://forms.gle/X6MMszPA4pxmAZmm9')
              }}
            >
